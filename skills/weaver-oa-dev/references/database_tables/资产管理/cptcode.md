...
| 5 | `capitalgroupflow` | 资产组流水 | `varchar2` | 80 | 是 | 资产组流水 |
| 6 | `capitaltypeflow` | 资产类型流水 | `varchar2` | 80 | 是 | 资产类型流水 |
| 7 | `buydateflow` | 购置日期流水 | `varchar2` | 80 | 是 | 购置日期流水 |
| 8 | `warehousingflow` | 备用字段 | `varchar2` | 80 | 是 | 备用字段 |
| 9 | `startcodenum` | 起始流水号 | `integer` | - | 是 | 起始流水号 |
| 10 | `assetdataflow` | 资产流水 | `varchar2` | 80 | 是 | 资产流水 |
