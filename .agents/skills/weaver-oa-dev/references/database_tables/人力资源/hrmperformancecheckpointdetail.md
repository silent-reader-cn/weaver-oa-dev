# 泛微OA 数据表: `hrmperformancecheckpointdetail`

- **所属模块**: `人力资源`
- **数据库表名**: `hrmperformancecheckpointdetail`
- **字段总数**: `12`
...
| 2 | `checkid` | 自定义考核方案id | `integer` | - | 是 | 自定义考核方案id |
...
| 10 | `targetindex` | 方案序列 | `varchar2` | 400 | 是 | 方案序列 |
