# 泛微OA 数据表: `workflow_monitor_bound`

- **所属模块**: `工作流程`
- **数据库表名**: `workflow_monitor_bound`
- **字段总数**: `13`
...
| :---: | :--- | :--- | :---: | :---: | :---: | :--- |
| 1 | `monitorhrmid` | 监控人id | `integer` | - | 是 | - |
...
| 8 | `isforcedrawback` | 是否可强制收回 | `char` | 1 | 是 | 1：可以，0：不可以 |
| 9 | `isforceover` | 是否可强制归档 | `char` | 1 | 是 | 1：可以，0：不可以 |
| 10 | `operator` | 操作人 | `integer` | - | 是 | - |
| 11 | `monitortype` | 监控类型 | `integer` | - | 是 | - |
| 12 | `subcompanyid` | 所属分部 | `integer` | - | 是 | - |
| 13 | `issooperator` | 是否可暂停撤销启用 | `varchar2` | 8 | 是 | 1：可以，0：不可以 |
