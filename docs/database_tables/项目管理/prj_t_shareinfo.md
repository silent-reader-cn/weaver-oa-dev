# 泛微OA 数据表: `prj_t_shareinfo`

- **所属模块**: `项目管理`
- **数据库表名**: `prj_t_shareinfo`
- **字段总数**: `16`
...
| 13 | `seclevelmax` | 安全级别(上限) | `integer` | - | 是 | 安全级别(上限) |
| 14 | `jobtitleid` | 岗位对象id | `integer` | - | 是 | - |
| 15 | `joblevel` | 岗位级别 | `integer` | - | 是 | - |
| 16 | `scopeid` | 0 | `varchar2` | 800 | 是 | - |
